...
$Q = mysqli_query($koneksi, "SELECT * FROM wisata ORDER BY id_wisata DESC"); // Mengurutkan secara descending berdasarkan kolom id
if ($Q) {
    $posts = array();
    ...
    file_put_contents('ambildata.php', "<?php echo '$data_json'; ?>"); // Simpan ke file agar bisa diakses
}
        ...
        ?>
            <div class="col-md-15th mb-4">
                <div class="card h-100 shadow-sm">
                    <?php if (!empty($item->foto_wisata)) { ?>
                        <img src="uploads/wisata/<?php echo $item->foto_wisata; ?>" class="card-img-top" alt="<?php echo $item->nama_wisata; ?>" style="height: 200px; object-fit: cover;">
                    <?php } else { ?>
                    ...
                    <?php } ?>
                    <div class="card-body">
                        <h5 class="card-title"><?php echo $item->nama_wisata; ?></h5>
                        <p class="card-text">
                        ...
                        <a href="detail.php?id_wisata=<?php echo $item->id_wisata; ?>" class="btn btn-primary btn-sm w-100">
            ...
            <div class="col-md-15th mb-4">
                <div class="card h-100 shadow-sm">
                    ...
                    <div class="image-container">
                        <?php if (!empty($item->foto_wisata)) { ?>
                            <img src="uploads/wisata/<?php echo $item->foto_wisata; ?>" class="card-img-top" alt="<?php echo $item->nama_wisata; ?>">
                        <?php } else { ?>
